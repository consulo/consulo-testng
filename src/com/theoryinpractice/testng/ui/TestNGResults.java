	...
	protected ToolbarPanel createToolbarPanel()
	{
		final ToolbarPanel panel = new ToolbarPanel(getProperties(), myEnvironment, this)
		{
					...
					DefaultActionGroup actionGroup, TestConsoleProperties properties, ExecutionEnvironment environment, JComponent parent)
			{
				...
				actionGroup.addAction(new ToggleBooleanProperty(ExecutionBundle.message("junit.runing.info.include.non.started.in.rerun.failed" +
						".action.name"), null, AllIcons.RunConfigurations.IncludeNonStartedTests_Rerun, properties,
