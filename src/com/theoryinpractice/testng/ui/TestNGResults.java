...
public class TestNGResults extends TestResultsPanel implements TestFrameworkRunningModel
{
	...
	public TestNGResults(final JComponent component, final TestNGConfiguration configuration, final TestNGConsoleView console)
	{
		super(component, console.getConsole().createConsoleActions(), console.getProperties(), TESTNG_SPLITTER_PROPERTY, 0.5f);
